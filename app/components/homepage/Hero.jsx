...
const Hero = () => {
  return (
    <div className="backdrop-opacity-60	  py-8 px-16 pb-6 sm:pb-8 lg:pb-12">
      <div className="mx-auto max-w-screen-xl px-4 md:px-8">
        <section className="flex flex-col justify-between gap-6 sm:gap-10 md:gap-16 lg:flex-row items-center">
          <div className="flex flex-col justify-between xl:w-5/12 text-nowrap">
            <div></div>
